const NavButton = ({ link, label, btnColor }) => {
  return (
    <a
      target="_blank"
      className=" hover:text-gray-900 text-gray-600 font-semibold"
      href={link}
    >
      {label}
    </a>
    ...
    <header className="w-full h-[60px] flex justify-between items-center">
      ...
      <nav className="w-2/4 h-full flex justify-center items-center">
        <ul className="flex justify-evenly w-full">
          <NavButton
            link={"https://github.com/JDLSantos21"}
            label={
              <svg
          ...
          <NavButton
            link={
              "https://www.linkedin.com/in/jose-armando-de-los-santos-amadis-689b091b7/"
            }
            label={
              <svg
                xmlns="http://www.w3.org/2000/svg"
